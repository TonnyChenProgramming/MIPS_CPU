...
REM
REM Generated by Vivado on Sun Nov 09 17:51:06 +1300 2025
...
echo "xvlog --incr --relax -prj SingleCycleCPUtb_vlog.prj"
call xvlog  --incr --relax -prj SingleCycleCPUtb_vlog.prj -log xvlog.log

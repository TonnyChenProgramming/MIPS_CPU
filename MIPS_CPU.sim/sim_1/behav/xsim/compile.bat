...
REM
REM Generated by Vivado on Sun Nov 23 19:15:48 +1300 2025
...
echo "xvlog --incr --relax -prj Top_Pipeline_CPU_tb_vlog.prj"
call xvlog  --incr --relax -prj Top_Pipeline_CPU_tb_vlog.prj -log xvlog.log

...
HD_PWD='C:/FPGAProject/MIPS_CPU/MIPS_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Single_Cycle_CPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Single_Cycle_CPU.tcl

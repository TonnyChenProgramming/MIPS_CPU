...
module InstructionToControlSignal(
    ...
    // branch control signals and control hazard detection
    input wire     equal,      // from register file comparison
    ...
    // branch control hazard detection
    wire is_beq = (op == 6'd4);
    wire is_bne = (op == 6'd5);

    assign ifid_flush = (is_beq && equal) ||
                        (is_bne && ~equal);
